...
| PRD-000046-UI     | UI     | Add Startup Loading Animation             | Proposed | Backlog | Show a lightweight startup animation of a quill or pen writing on a blank page while Quill is starting. |
