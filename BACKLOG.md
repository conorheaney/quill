...
| PRD-000046-BUG    | BUG    | Stabilize Recent Files Rendering           | Proposed | Backlog | Investigate and correct intermittent rendering of Recent Files entries so available items remain consistently visible, aligned, and actionable. |
