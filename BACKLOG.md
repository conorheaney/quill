...
| PRD-000008-TECH | TECH | Refactor Stylesheet Structure | Done | Release | Reshape the CSS into clearer sections and ownership boundaries so shell, panes, dialogs, and theme tokens are easier to maintain. Break themes into separate named stylesheets covering colors, fonts, and rendering styles. |
