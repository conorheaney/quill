/**
 * Static application configuration and built-in document content.
 */
...
window.QuillConfig = (() => {
      ...
      const DEFAULT_CONTENT = `# Getting Started With Quill
...
`;
      const NEW_DOCUMENT_CONTENT = `# Untitled Document

Start writing here. Your next excellent idea is probably closer than it looks.
`;
