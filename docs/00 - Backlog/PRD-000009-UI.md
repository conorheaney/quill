...
- Define the selection UI, initial theme set, persistence behavior, and first implementation slice during `01 - Plan`.

## Acceptance Criteria

- Define the concrete theme-picker behavior and pass conditions during `01 - Plan`.
