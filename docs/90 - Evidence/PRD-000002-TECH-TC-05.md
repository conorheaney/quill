...
| Test | Run controller success, cancellation, error, stale-completion, and missing-dependency cases using the approved fake desktop bridge, storage, clock, and dialog dependencies. |
| Result | PASS |
